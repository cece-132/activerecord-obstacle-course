...
# ----------------------
  ...
  it '23. returns all orders which include item_4' do
    ...
    # ------------------ Improved Solution ----------------------
    #  Solution goes here
    order_ids = OrderItem.where(item_id: @item_4).pluck(:order_id)
  ...
  it '25. returns items that are associated with one or more orders' do
    ...
    # Solution goes here
    # ordered_items = Item.where(:orders).includes(:items)
    ordered_items = Item.joins(:order_items).where(id: Item.all).includes(:order_items)
    # ---------------------------------------------------------------
